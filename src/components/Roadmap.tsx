        ...
        <div className="max-w-4xl mx-auto" ref={ref as React.RefObject<HTMLDivElement>}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-6 relative" ref={lineContainerRef}>
              ...
              <div 
                className="absolute w-1.5 bg-gradient-to-b from-sky-500 via-indigo-500 to-orange-500 left-4 top-0 transition-all duration-700 ease-out rounded-full"
              ...
              {storySteps.map((step, index) => (
                <div 
                  key={index}
                  className={`relative pl-12 py-4 transition-all duration-500 cursor-pointer rounded-lg ${
                    activeStoryIndex === index 
                      ? 'scale-105 bg-gray-50 shadow-sm border border-gray-100' 
