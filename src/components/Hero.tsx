  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#f8f9fa]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[30%] right-[20%] animate-float animation-delay-2000 transform-gpu duration-300 floating-element z-[-1]">
        ...
        <div className="absolute bottom-[25%] left-[25%] animate-float animation-delay-1000 transform-gpu duration-300 floating-element z-[-1]">
