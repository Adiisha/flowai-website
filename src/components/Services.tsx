  ...
  return (
    ...
    >
      <div className="p-6 h-full flex flex-col relative overflow-hidden">
        ...
        <h5 className="mb-3 text-xl font-bold">{service.title}</h5>
        ...
        <div 
          ...
          style={{ zIndex: 10 }}
        >
          <h5 className="mb-3 text-xl font-bold text-sky-600">{service.title}</h5>
          <p className="text-base text-gray-700 mb-4">{service.description}</p>
          
          <div className="mt-auto">
            <Link to={`/services/${service.id}`} className="btn-primary w-full text-center py-2">
              Learn More
            </Link>
          </div>
        </div>
