...
const ServiceCard = ({ icon, title, description, technologies, index }: ServiceCardProps) => {
  ...
  return (
    <div
      ...
      className={`card card-hover relative overflow-hidden transition-all duration-300 ${
